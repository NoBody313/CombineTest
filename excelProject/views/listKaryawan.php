...
<body>
    <div class="flex flex-col bg-white">
        <div class="flex flex-row" id="sideHeader">
            <?php include('/CombineTest/excelProject/views/layout/miniSidebar.php') ?>
            <section class="content flex flex-col w-full p-4">
                ...
                <div class="excelFun flex flex-row w-auto h-auto px-4 justify-end">
                    <div class="importExcel w-auto px-8 py-4 ">
                        <form class="pb-4 pt-4" action="" method="POST" enctype="multipart/form-data">
                            <input type="file" accept=".xls,.xlsx" name="fileExcel" id="uploadFile"
                                class="file-input file-input-bordered file-input-info w-auto bg-white" />
                    ...
                    <div class="exportExcel pt-2">
                        <h1
                            class="flex flex-row my-4 py-4 px-8 bg-green-500 text-white font-medium text-base rounded-md leading-8">
                            <span>
                ...
                <div
                    class="flex flex-col w-full p-4 border border-blue-400 bg-blue-50 rounded-md text-gray-800 placeholder-gray-400">
                            ...
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-4 py-2 text-blue-700" scope="row">
                                    ...
                                    <a href="listEditKaryawan.php?op=delete&id=<?php echo $id?>"
                                        onclick="return confirm('Apakah anda yakin untuk menghapus data ini?')"><button
                                            type="button"
