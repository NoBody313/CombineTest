    ...
    <div class="flex flex-col">
        <div class="flex flex-row" id="sideHeader">
            ...
            <section class="content container flex flex-col p-4">
                ...
                <div class="container block w-full p-4 border border-blue-400 bg-blue-50 mt-4 rounded-md ">
                    <h1 class="font-medium text-md">Add New Data</h1>

                    <form action="" method="POST" class="p-4 my-4">
                        <div class="mb-3 flex flex-col">
                            <label for="nama" class="mb-1">Nama</label>
                            <input type="text" class="px-3 py-2 border rounded-md" id="nama" name="nama" value="<?php echo $nama ?>">
                        </div>

                        <div class="mb-3 flex flex-col">
                            <label for="nik" class="mb-1">NIK</label>
                            <input type="text" class="px-3 py-2 border rounded-md" id="nik" name="nik" value="<?php echo $nik ?>">
                        </div>
                        <div class="mb-3 flex flex-col">
                            <label for="direktorat" class="mb-1">Direktorat</label>
                            <input type="text" class="px-3 py-2 border rounded-md" id="direktorat" name="direktorat" value="<?php echo $direktorat ?>">
                        </div>
                        <div class="mb-3 flex flex-col">
                            <label for="unit" class="mb-1">Unit</label>
                            <input type="text" class="px-3 py-2 border rounded-md" id="unit" name="unit" value="<?php echo $unit ?>">
                        </div>
                        <div class="mb-3 flex flex-col">
                            <label for="jobTitle" class="mb-1">Nama Jabatan</label>
                            <input type="text" class="px-3 py-2 border rounded-md" id="jobTitle" name="jobTitle" value="<?php echo $jobTitle ?>">
                        </div>
                        <div class="mb-3 flex flex-col">
                            <label for="tglEfektifResign" class="mb-1">Tgl Efektif Resign</label>
                            <input type="text" class="px-3 py-2 border rounded-md" id="tglEfektifResign" name="tglEfektifResign" value="<?php echo $tglEfektifResign ?>">
